...
const AR = {
  ...
  signup: {
    ...
    addressInvalid: "تحقق من اسم العمارة والمدينة وعنوان المبنى ورقم الشقة.",
  },
  register: {
  ...
  verifyPhone: {
    ...
    subtitle: "أدخل نفس الجوال أو البريد المسجل في حسابك، ثم الرمز المكوّن من 6 أرقام الذي يظهر في سجل الخادم بعد «إرسال رمز» من الملف الشخصي.",
  ...
  maintenance: {
    ...
    aiHint:
      "يحلّل النموذج وصف المشكلة (شخصية أو مجتمعية)، يقدّر نافذة زمنية للصيانة والحد الأقصى للانتظار، ثم يقترح شركات صيانة. للصيانة المجتمعية يُفتح تصويت تلقائياً على الشركات المقترحة.",
    ...
    communityVotePending: "يُنشأ تصويت الشركات تلقائياً عند توفر ترشيحات من النموذج.",
  ...
  votes: {
    ...
    kindCompanyDesc:
      "عند تقديم طلب صيانة مجتمعي يُنشأ تصويت تلقائياً على الشركات التي رشّحها النموذج.",
...
const EN = {
  ...
  signup: {
    ...
    addressInvalid: "Check the building name, city, address text, and unit number.",
  },
  register: {
  ...
  verifyPhone: {
    title: "Verify phone",
    subtitle:
      "Enter the same phone number or email on your Amarati profile, plus the 6‑digit OTP shown in the server logs after “Send verification code”.",
  ...
  maintenance: {
    ...
    communityVotePending: "A company vote is created automatically when the model returns recommendations.",
  ...
  votes: {
    ...
    kindCompanyDesc:
      "When someone files a community maintenance request, a vote is created automatically on the AI-recommended companies.",
