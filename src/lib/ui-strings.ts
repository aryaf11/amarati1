...
const AR = {
  ...
  chat: {
    ...
    tabGroup: "محادثات جماعية",
    groupPinned: "إذا أحد يحتاج إضافة موضوع يكتب لنا",
    placeholder: "...اكتب رسالتك",
    send: "إرسال",
...
const EN = {
  ...
  chat: {
    ...
    tabGroup: "Group chats",
    groupPinned: "To suggest a topic for the agenda, message us here",
    placeholder: "Write your message…",
    send: "Send",
    back: "Back to home",
