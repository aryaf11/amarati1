...
const AR = {
  ...
  assistant: {
    ...
    quickNextVisit: "متى موعد الصيانة القادمة؟",
  ...
  chat: {
    ...
    emptyAnnouncements: "لا إعلانات بعد.",
    openAnnouncements: "فتح صفحة الإعلانات",
    placeholder: "اكتب رسالتك...",
    send: "إرسال",
...
const EN = {
  ...
  assistant: {
    ...
    quickNextVisit: "When is the next maintenance visit?",
  ...
  chat: {
    ...
    openAnnouncements: "Open announcements page",
    placeholder: "Write your message…",
    send: "Send",
    back: "Back to home",
